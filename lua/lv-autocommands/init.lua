...
local markdown_format = {'BufWritePre', '*.md', 'lua vim.lsp.buf.formatting_sync(nil,1000)'}
if O.markdown.autoformat then table.insert(auto_formatters, markdown_format) end
